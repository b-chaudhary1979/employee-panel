...
export default function Support() {
  return (
    <div className="rounded-xl shadow-md p-6 mt-8 bg-white border border-gray-100 flex flex-col items-center text-center w-full">
      <h2 className="text-xl font-bold mb-2" style={{ color: "#a259f7" }}>Need Help or Support?</h2>
      ...
      <a
        ...
        style={{ background: "linear-gradient(90deg, #a259f7 0%, #b78aeb 100%)", boxShadow: "0 2px 8px 0 rgba(162,89,247,0.10)" }}
      >
        Email Support
      </a>
    </div>
