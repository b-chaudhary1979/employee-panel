...
const EmployeeCard = ({ user }) => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl border border-purple-100 transform hover:-translate-y-1">
      ...
      <div className="p-6">
        <div className="flex items-center mb-6">
          <div className="relative">
            <div className="w-24 h-24 rounded-full bg-gradient-to-br from-purple-200 via-pink-200 to-blue-200 flex items-center justify-center shadow-lg overflow-hidden border-4 border-white">
              {user.photo ? (
                <img 
              ...
              <svg className={`w-12 h-12 text-purple-500 ${user.photo ? 'hidden' : ''}`} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
          ...
          <div className="ml-6">
            ...
            <p className="text-purple-600 font-medium">{user.department || 'Department'}</p>
          </div>
        </div>
