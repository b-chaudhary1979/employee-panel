...
export default function AddPasswordModal({
  ...
  const [form, setForm] = useState(
    initialData
      ? {
          ...initialData,
          employee: Array.isArray(initialData.employee)
            ...
            >
              ...
              <div className="lg:col-span-3 sm:col-span-2 col-span-1">
                <label className="text-xs font-semibold mb-1 text-gray-700 flex items-center gap-2">
                  <FaUserShield className="text-purple-400" /> Password
              ...
              <div>
                <label className="text-xs font-semibold mb-1 text-gray-700 flex items-center gap-2">
                  <FaCalendarAlt className="text-purple-400" /> Password Expiry
                  Date
                </label>
                <input
                  type="date"
              ...
              <div className="sm:col-span-2 lg:col-span-1">
                    ...
                    {form.employee.length > 1 && (
                      <button
                        ...
                        onClick={() => {
                          setForm((f) => ({
                            ...f,
                            employee: f.employee.filter((_, i) => i !== idx),
                          }));
                        }}
                        title="Remove"
                      >
                ...
                <button
                  type="button"
                  className="text-xs text-purple-600 hover:text-purple-800 font-semibold px-2 py-1 rounded-xl border border-purple-100 bg-purple-50 mt-1 transition"
                  onClick={() =>
                    setForm((f) => ({ ...f, employee: [...f.employee, ""] }))
                  }
                >
                  + Add Employee
                </button>
