        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm">
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 relative animate-modalIn">
            ...
            <div className="space-y-2 text-gray-600 text-sm">
              <div>
                <span className="font-semibold">Website/Service:</span>{" "}
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="font-mono bg-gray-100 px-2 py-1 rounded">
                  {modalPasswordVisible
                    ...
                    : "•".repeat(
                        Math.max(8, selectedPassword.password?.length || 8)
                      )}
                </span>
                <button
                  ...
                  aria-label={
                    modalPasswordVisible ? "Hide password" : "Show password"
                  }
                >
                  {modalPasswordVisible ? (
                    <svg
                    ...
                    >
                      ...
                      <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
                        d="M17.94 17.94A10.97 10.97 0 0112 19c-5.52 0-10-4.48-10-10 0-2.21.72-4.25 1.94-5.94M9.88 9.88A3 3 0 0112 9c1.66 0 3 1.34 3 3 0 .39-.07.76-.18 1.11"
                      />
                    </svg>
                  ) : (
                    <svg
                ...
                >
                  ...
                  >
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      d="M8 16h8M8 12h8m-7 8h6a2 2 0 002-2V7a2 2 0 00-2-2h-6a2 2 0 00-2 2v11a2 2 0 002 2z"
                    />
                  </svg>
                </button>
              </div>
              <div>
                <span className="font-semibold">Employee/User:</span>{" "}
                {selectedPassword.employee}
              </div>
              <div>
              ...
              {selectedPassword.customFields &&
                selectedPassword.customFields.length > 0 && (
                  <div>
        ...
        <AddPasswordModal
          ...
          onAdd={(data) => {
            setPasswords((passwords) =>
              passwords.map((p) =>
                p.createdAt === editPassword.createdAt ? { ...p, ...data } : p
              )
            );
                ...
                <table className="min-w-full divide-y divide-gray-200 text-xs">
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th className="px-3 py-2 text-left font-medium text-gray-500 uppercase tracking-wider whitespace-nowrap hidden xs:table-cell">
                        Password
                      </th>
                      <th className="px-3 py-2 text-left font-medium text-gray-500 uppercase tracking-wider whitespace-nowrap hidden md:table-cell">
                        Employee/User
                      </th>
                      <th className="px-3 py-2 text-left font-medium text-gray-500 uppercase tracking-wider whitespace-nowrap hidden sm:table-cell">
                        Strength
                      </th>
                      <th className="px-3 py-2 text-left font-medium text-gray-500 uppercase tracking-wider whitespace-nowrap hidden sm:table-cell">
                        Duplicate
                  ...
                  <tbody className="bg-white divide-y divide-gray-100">
                    ...
                    {filteredPasswords.map((p, idx) => (
                      ...
                      >
                        ...
                        <td className="px-3 py-2 whitespace-nowrap align-top">
                          <div className="flex items-center gap-2">
                            ...
                            <button
                              ...
                              onClick={(e) => {
                                e.stopPropagation();
                                setTablePasswordVisible((v) => ({
                                  ...v,
                                  [idx]: !v[idx],
                                }));
                              }}
                              title={
                                tablePasswordVisible[idx] ? "Hide" : "Show"
                              }
                              aria-label={
                                tablePasswordVisible[idx]
                                  ? "Hide password"
                        ...
                        <td className="px-3 py-2 whitespace-nowrap align-top text-xs md:text-sm">
                          {p.username}
                        </td>
                        ...
                        <td className="px-3 py-2 whitespace-nowrap text-center align-middle">
                          <div className="flex gap-2 items-center justify-center">
                            ...
                            <button
                              ...
                              onClick={(e) => {
                                e.stopPropagation();
                                handleDelete(filteredPasswords.indexOf(p));
                              }}
                              title="Delete Password"
                              aria-label="Delete password"
                            >
