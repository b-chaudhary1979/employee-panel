        ...
        >
          <div className="max-w-6xl mx-auto">
            <div className="flex items-center justify-between mb-8">
              <h2 className="text-2xl sm:text-4xl font-extrabold text-[#a259f7] tracking-tight animate-fade-in-up">
                Instructions
              </h2>
              <button
                className="bg-[#a259f7] hover:bg-[#7c3aed] text-white font-semibold py-1 px-3 sm:py-2 sm:px-6 rounded-lg shadow transition-colors duration-200 text-sm sm:text-base"
              ...
              <ol className="list-decimal list-inside space-y-6 text-lg md:text-xl text-gray-300 animate-fade-in-up">
                    ...
                    <ul className="list-disc ml-8 mt-2 space-y-1">
                      ...
                      <li>
                        <span
                          className="underline cursor-pointer hover:text-[#a259f7]"
                          onClick={() =>
                            (window.location.href = "/notes-tasks")
                          }
                        >
                          Notes & Tasks
                        </span>
                ...
                <li>
                  ...
                  <span>
                    ...
                    <span
                      className="underline cursor-pointer hover:text-[#a259f7]"
                      onClick={() => (window.location.href = "/notes-tasks")}
                    >
                      Notes & Tasks
                    </span>{" "}
            ...
            <h2 className="text-4xl font-extrabold text-[#a259f7] mb-8 tracking-tight animate-fade-in-up">
              How to Use
            </h2>
