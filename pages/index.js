...
export default function Home() {
  ...
  return (
    <div className="bg-[#fbf9f4] min-h-screen relative">
      ...
      {notification.show && (
        <div
          className={`fixed top-20 right-4 z-[9999] transform transition-all duration-500 ease-in-out ${
            notification.show
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="flex items-center group cursor-pointer hover:scale-105 transition-transform duration-300">
              ...
              <span className="ml-4 font-bold text-2xl text-gray-900 bg-gradient-to-r from-gray-900 to-[#a259f7] bg-clip-text text-transparent">
                Cyber Clipper
              </span>
            </div>
            ...
            <nav className="hidden md:flex space-x-1">
              <a
                ...
                className={`px-4 py-2 transition-all duration-300 font-medium relative group rounded-lg hover:bg-[#a259f7]/5 ${
                  activeSection === "home"
                    ? "text-[#a259f7] font-bold !text-[#a259f7]"
                    : "text-gray-700 hover:text-[#a259f7]"
                }`}
              >
                Home
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8 animate-slide-in-left">
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                ...
                evolving threats. Our comprehensive platform ensures your data
                stays safe and your operations remain uninterrupted.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 animate-fade-in-up">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Everything you need to secure your digital infrastructure and
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div
              className="bg-[#fbf9f4] p-8 rounded-xl border border-gray-100 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-2 animate-fade-in-up"
            ...
            >
              ...
              <p className="text-gray-600">
                Multi-layered security protocols with real-time threat detection
            ...
            >
              ...
              <p className="text-gray-600">
                Optimized performance that doesn't compromise security.
                Experience seamless operations with minimal latency.
              </p>
            </div>
            ...
            >
              ...
              <p className="text-gray-600">
                Comprehensive insights and reporting tools to monitor your
                security posture and track performance metrics.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              See how Cyber Clipper can transform your security posture.
          ...
          <form
            ...
            className="bg-gradient-to-br from-white to-[#fbf9f4] p-8 rounded-2xl shadow-xl border-2 border-[#a259f7] hover:shadow-2xl transition-all duration-300"
          >
            ...
            <div className="space-y-8">
              <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
                ...
                <p className="text-gray-600 leading-relaxed mb-6">
                  To provide cutting-edge cybersecurity solutions that empower
                  businesses to operate securely in an increasingly complex
                  digital landscape. We believe that security should be
                  accessible, effective, and seamless.
                </p>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
                ...
                <p className="text-gray-600 leading-relaxed mb-6">
                  To create a world where businesses can focus on growth and
                  innovation without worrying about cybersecurity threats. We
                  envision a future where security is proactive, intelligent,
                  and invisible.
                </p>
                <div className="flex items-center space-x-4">
                  <div className="w-12 h-12 bg-[#a259f7] rounded-lg flex items-center justify-center">
            ...
            <div className="space-y-8">
              <div className="bg-gradient-to-br from-[#a259f7] to-[#8b4fd8] p-8 rounded-2xl text-white">
                ...
                <p className="text-lg leading-relaxed mb-6">
                  Founded by cybersecurity veterans who witnessed the growing
                  complexity of digital threats, Cyber Clipper was born from a
                  simple belief: security should protect, not hinder.
                </p>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Honest, transparent, and trustworthy partnerships
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <section className="py-20 bg-[#fbf9f4]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Why Choose Cyber Clipper?
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We're not just another security solution. We're your trusted
              partner in digital protection.
            </p>
          </div>
            ...
            <div className="space-y-8">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Our cybersecurity experts have decades of combined
                    experience in protecting businesses of all sizes.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Trusted by thousands of businesses worldwide with a 99.9%
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              <div className="space-y-6">
                ...
                <div className="w-full bg-gray-200 rounded-full h-3">
                  <div
                    className="bg-[#a259f7] h-3 rounded-full"
                    style={{ width: "98%" }}
                  ></div>
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-2xl font-bold text-[#a259f7]">
                    &lt;30s
                  </span>
                </div>
                <div className="w-full bg-gray-200 rounded-full h-3">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="col-span-2">
              <div className="flex items-center mb-6 group">
                ...
                <span className="ml-4 font-bold text-2xl bg-gradient-to-r from-white to-[#a259f7] bg-clip-text text-transparent">
                  Cyber Clipper
                </span>
              </div>
              <p className="text-gray-300 mb-6 max-w-md leading-relaxed">
                Protecting businesses worldwide with advanced cybersecurity
                solutions. Your security is our priority.
              </p>
              <div className="flex space-x-4">
                <a
                  href="#"
                  className="text-gray-400 hover:text-[#a259f7] transition-all duration-300 transform hover:scale-110 p-2 rounded-full hover:bg-[#a259f7]/10"
                >
                  <svg
                    className="w-6 h-6"
                    fill="currentColor"
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <a
                    href="#home"
                    className="text-gray-300 hover:text-[#a259f7] transition-all duration-300 hover:translate-x-1 inline-block"
                  >
                    Home
                  </a>
                </li>
          ...
          <div className="border-t border-gray-700 mt-12 pt-8 text-center">
            <p className="text-gray-400">
              &copy; 2024 Cyber Clipper. All rights reserved.
            </p>
            <div className="mt-4 flex justify-center space-x-6 text-sm text-gray-500">
              <a
                href="#"
                className="hover:text-[#a259f7] transition-colors duration-300"
              >
                Privacy Policy
              </a>
              <a
