            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-8 animate-slide-in-left">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  Advanced cybersecurity solutions that protect your business
                  from evolving threats. Our comprehensive platform ensures your
                  data stays safe and your operations remain uninterrupted.
                </p>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              >
                ...
                <p className="text-gray-600">
                  Multi-layered security protocols with real-time threat
